"""
Django settings for cc_projects project.
...
SECRET_KEY = '$e@(&naowi**54l6fkk@j6uok7cdj33f$-^-7au7-q)r-6i8r2'
...
WSGI_APPLICATION = 'cc_projects.wsgi.application'
